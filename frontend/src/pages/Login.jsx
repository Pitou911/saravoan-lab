    ...
    <div className="min-h-screen flex" style={{ background: 'linear-gradient(135deg, #1a3a5c 0%, #0f2240 60%, #c0392b 100%)' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center p-12 text-white">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 w-full max-w-xs">
          {['Patient Records','Test Requests','Print Reports','Secure Access'].map(f => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <h2 className="text-2xl font-bold mb-1" style={{ color: '#1a3a5c' }}>Welcome back</h2>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:border-transparent transition pr-10"
                    placeholder="••••••••"
                  />
